...
cat - /usr/share/gatling-charts-highcharts-bundle-2.3.0/results/*/simulation.log <<END | /usr/share/logstash-6.5.3/bin/logstash --path.settings /usr/share/logstash-6.5.3/config -f /gatling_logstash.conf
